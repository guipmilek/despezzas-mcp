...
Copy-paste values for the ChatGPT **Apps & Connectors → Create/Add App** screen, plus the logo file to upload.

## Logo

Use [`assets/despezzas-mcp.png`](../assets/despezzas-mcp.png) — the official Despezzas double-Z app icon (512x512, light lavender background `#f1f6ff`, near-black mark `#171717`). Upload it as-is as the app/connector icon.
...
|---|---|
| **Name** | `Despezzas` |
| **Description (short)** | `Personal finance for Despezzas: check accounts, cards, categories, and spending, and log transactions.` |
| **Server URL / MCP endpoint** | `https://despezzas-mcp.guipmilek.workers.dev/mcp` |
